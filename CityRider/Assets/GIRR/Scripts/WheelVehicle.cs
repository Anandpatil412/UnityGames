...
namespace VehicleBehaviour {
    ...
    public class WheelVehicle : MonoBehaviour {
        ...
        [SerializeField] AnimationCurve turnInputCurve1 = AnimationCurve.Linear(-1.0f, -1.0f, 1.0f, 1.0f);
        ...
        private AnimationCurve motorTorque1 = new AnimationCurve(new Keyframe(0, 10), new Keyframe(10, 70), new Keyframe(90, 0));
        ...
        void FixedUpdate () {
            ...
            if (isPlayer) {
                ...
                // Turn
                steering = turnInputCurve1.Evaluate(GetInput(turnInput)) * steerAngle;
                // Dirft
            ...
            else if (Mathf.Abs(speed) < 4 || Mathf.Sign(speed) == Mathf.Sign(throttle))
            {
                ...
                {
                    wheel.motorTorque = throttle * motorTorque1.Evaluate(speed) * diffGearing / driveWheel.Length;
                }
            }
            else
            {
